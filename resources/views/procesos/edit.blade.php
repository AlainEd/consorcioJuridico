                                ...
                                <div class="row-span-2 p-6 border border-gray-100 rounded-xl bg-gray-50 sm:p-8">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-lg text-gray-500 hover:text-black">
                                            @if (Auth::user()->id_rol == 2)
                                                <x-jet-input class="block mt-1 w-full" id="fecha" type="date" name="fecha" :value="old('fecha')" require autofocus autocomplete="fecha"/>   
                                            @else
                                        ...
                                        <span class="text-lg text-gray-500 hover:text-black">
                                            @if (Auth::user()->id_rol == 2)
                                                <x-jet-input class="block mt-1 w-full" id="hora" type="time" name="hora" :value="old('hora')" require autofocus autocomplete="hora"/>   
                                            @else
                                ...
                                <div class="p-6 border border-gray-100 rounded-xl bg-gray-50 sm:space-x-8 sm:p-8">
                                    <div class="space-y-4 mt-4 text-center sm:mt-0 sm:text-left">
                                        ...
                                        <div>
                                            ...
                                            @else
                                                <span class="text-lg text-gray-500 hover:text-black">{{ $proceso->telefono }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
